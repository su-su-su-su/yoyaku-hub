...
menu_data = {
  ...
  "st3@example.com" => {
    "カット" => { sort_order: 1, price: 11000, duration: 30, description: "カリスマのカット", category: ["カット"], is_active: 1 },
    "カラー" => { sort_order: 2, price: 22000, duration: 60, description: "エレガントなカラーリング", category: ["カラー"], is_active: 1 },
    "パーマ" => { sort_order: 3, price: 22000, duration: 60, description: "クリエイティブなパーマ", category: ["パーマ"], is_active: 1 },
    "縮毛矯正" => { sort_order: 4, price: 33000, duration: 120, description: "自然な縮毛矯正", category: ["縮毛矯正", "スペシャル"], is_active: 1 }
  }
}
